...
See [Controllers](controllers.md) and [Right-Click](right-click.md).
- A tuning page lets you turn the plugin into a microtuning client accepting MTS ESP, MTS Sysex, MIDI 2.0, and Scala files. In addition, the pitchbend sensitivivty can be set. *Multichannel* tuning is supported! See [Tuning](docs/tuning.md).

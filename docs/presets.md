...
If they are different, they indicate the lower and uper bounds of a crossfade.
...
Some developers may chose to only duplicate a subset of parameters.
...
Opening a directory of preset files interpretes the directory as a bank (the developer may also have their own file format for banks).
...
Comments may include a license, an suggestion on how to use the preset, or any other information.
